...
<div class="fetchWomenDivTpNew">
<div class="container">
<div class="fetchWomenDivTpNewIn">
<div class="">
<!-- <center>
...
<div class="row mt-4 mb-4 homeCategoryDivNew">
...
<div class="row">
    <div class="col" id="noResultFound">
        <center>
            <h2 class="text-danger">
                No Results Found, View all Available Internships
            </h2>
        </center>
...
$(document).ready(function()
{
    ...
    $('html, body').animate({
            scrollTop: $('#noResultFound').offset().top
    }, 'slow');
  // Handler for .ready() called.
  
  function seeInternship() {
    $('html, body').animate({
