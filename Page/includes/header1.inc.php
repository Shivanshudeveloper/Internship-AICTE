...
<html lang="en">
  ...
  <body class="newBgRptr">
	  <div class="bg-top headerhmMainDivnew">
    	<div class="container">
    		<div class="row d-flex align-items-center align-items-stretch">
    			<div class="col-md-7 d-flex align-items-center py-4 hdrLogoDivnew">
    ...
    <nav class="navbar navbar-expand-lg ftco-navbar-light hderlightDivNew" id="ftco-navbar">
	    <div class="container">
				<button class="navbar-toggler text-light hderlightDivNewBtn" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
