...
<form id="msform">
  ...
  <fieldset>
    ...
    <input type="hidden" name="id" id="id" class="form-control mb-4" value="" placeholder="Id">
     <input type="text" name="title" id="title" class="form-control mb-4" placeholder=" Job Tittle">
     <input type="textarea" name="content" id="content" class="form-control mb-4" placeholder="Job Descritpion">
     <input type="text" name="city" id="city" class="form-control mb-4" placeholder="Job Location">
